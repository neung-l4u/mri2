...
<head>
    ...
    <title>เพิ่มบัญชีธนาคาร: <?php echo $bank['bank_name']; ?></title>
...
<div class="container py-5">
    ...
    <div class="bg-white p-4 rounded shadow-sm">
        <h4 class="mb-4">เพิ่มบัญชีธนาคาร<?php echo $bank['bank_name']; ?></h4>
        <form method="POST" action="bank_account_store.php">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="<?php echo $bank['bank_name']; ?>" disabled>
                    <input type="hidden" name="bank_id" value="<?php echo $id; ?>">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" step="1" id="transaction_count" name="transaction_count" class="form-control" value="0" min="0">
                </div>
                <div class="col-md-6">
